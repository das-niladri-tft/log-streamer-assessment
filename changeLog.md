**Primary Onbjective**
- Implemented complete WebSocket server with the components mentioned in the `README.md`
- Testing the Implementation as instructed

**Bonus Challanges**
- Implemented all the bonus challanges
